...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="src{{asset('template/assets/favicon/apple-icon-57x57.png')}}">
    <link rel="apple-touch-icon" sizes="60x60" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png')}}">
    <link rel="icon" type="image/png" sizes="96x96" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <link rel="manifest" href="src{{('template/assets/favicon/manifest.json')}}">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="src{{ asset('template/assets/favicon/apple-icon-60x60.png') }}">
    <meta name="theme-color" content="#ffffff">
    <!-- Vendors styles-->
    <link rel="stylesheet" href="template/node_modules/simplebar/dist/simplebar.css">
    <link rel="stylesheet" href="css/vendors/simplebar.css">
    <!-- Main styles for this application-->
    <link href="src{{asset ('/public/template/scss/style.scss') }}" rel="stylesheet">
        ...
        <div class="container-fluid border-bottom px-4">
          ...
          <ul class="header-nav">
            ...
            <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/8.jpg" alt="user@email.com"></div></a>
                      ...
                      <tbody>
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/2.jpg" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/3.jpg" alt="user@email.com"><span class="avatar-status bg-warning"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/4.jpg" alt="user@email.com"><span class="avatar-status bg-secondary"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/5.jpg" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="template/assets/img/avatars/6.jpg" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
